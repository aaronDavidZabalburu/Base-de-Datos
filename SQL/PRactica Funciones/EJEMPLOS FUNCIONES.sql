...
INITCAP:ModoTitulo (Iniciales de las palabras en may√∫scula)*/
...
SUBSTR(campo,posici√≥n de inicio) : Devuelve el substring que va desde la posicion de inicio hasta el final.
SUBSTR(Campo, posici√≥n de inicio, cuantos caracteres coger) : Devuelve el substring que comienza en la posicion de inicio tomando el numero de caracteres que indica el tercer parametro)*/
...
--4.  Mostrar el primer apellido de los empleados que tienen nombre compuesto (Jose Luis, Ana MarÌa,...)
...
/***************************************************************************************************************************/ 
--7. MOSTRAR descripciÛn + de +  fabricante, color, tama√±o y 
...
SUBSTR(descripcion,INSTR(descripcion,' ',1,2)+1,INSTR(descripcion,' ',1,3)-INSTR(descripcion,' ',1,2)-1) "TAMA√ëO MANTEL",
...
/* Sumar o restar n√∫meros a una fecha suma o resta dias a esa fecha*/

SELECT codigo,fpedido,fpedido-3 "Fecha de env√≠o estimada" FROM pedidos;
...
/*************************LAST_DAY******************************************
LAST_DAY:Devuelve la fecha del √∫ltimo d√≠a del mes y a√±o pasado en la fecha*/
...
/* Poner una calificaciÛn a los empleados en un nuevo campo que ser· en funciÛn de las ventas
